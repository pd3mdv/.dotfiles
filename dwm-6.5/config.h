...
static const char *light_up[] = {"/usr/bin/lxqt-backlight_backend", "--inc", NULL};
//static const char *light_down[] = {"/sbin/brightnessctl", "-d", "intel_backlight", "s", "5%-", NULL};
static const char *light_down[] = {"/usr/bin/lxqt-backlight_backend", "--dec", NULL};
...
static const char *const autostart[] = {
    ...
    "feh", "--bg-fill", "/home/h4mm3r/Pictures/Wallpaper/23809552-2479097507.png", NULL,
    "dwmblocks", NULL, 
    "picom", NULL, 
    "dunst", NULL, 
...
static const char *dmenucmd[] = {
    "dmenu_run", "-m",    dmenumon, "-fn",  dmenufont, "-nb",  norm_bg, "-nf",       norm_fg, "-sb",    sel_bg, "-sf",     sel_fg, NULL
};
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_4, 3){MODKEY | ShiftMask, XK_e, quit, {0}},
};
